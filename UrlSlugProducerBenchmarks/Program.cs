...
namespace UrlSlugBenchmarks
{
    ...
    public class Program
    {
        ...
        private readonly SlugProducerBase slugProducerV2_2 = new SlugProducerV2_2();

        [Params(
            "abcdegfhijklmnopqrstuvwxyz0123456789",
            "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789",
            "@#a$@bc%d&^*^%&*EF$%^&GHI^&*&^J()_KLMNOPQRSTUVWXYZ0123456789&^*)",
            " @#a$ @bc%.d&^*" + "–" + "^%&*EF$%^&GHI^&*&^J()_KLMNOPQRS TUVWXYZ0123456789&^*) ",
            "A B.C-D" + "–" + "EFGHIJKLMNOPQRSTUVWXYZ0123456789",
